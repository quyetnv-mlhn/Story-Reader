...
class $AssetsThemeGen {
  ...
  /// File path: assets/theme/appainter_dark_theme.json
  String get appainterDarkTheme => 'assets/theme/appainter_dark_theme.json';

  /// File path: assets/theme/appainter_theme.json
  String get appainterTheme => 'assets/theme/appainter_theme.json';

  /// List of all assets
  List<String> get values => [appainterDarkTheme, appainterTheme];
}
